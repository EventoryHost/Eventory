...
import { saveDecoratorData , getDecoratorData } from '@/services/flows/decoratorService';
...
export const { resetDecoratorState, updateFormData, setcurrentPage2 } = decoratorSlice.actions;
