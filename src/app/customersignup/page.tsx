...
const SignUp = (props: Props) => {
  ...
  return (
    <div className="flex min-h-[88vh] w-full flex-col overflow-hidden lg:flex-row">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center gap-9 backdrop-brightness-50">
          <div className="flex flex-col items-center justify-center gap-4 rounded-lg bg-white p-6 shadow-lg">
            ...
            <Link href={"/customersignup"} className="mb-9 font-semibold underline">Not you?</Link>
            <InputOTP
              maxLength={6}
              className=""
            ...
            <Link href={"/customersignup"} className="font-semibold underline">Resend OTP</Link>
            <button
      ...
      <OtpModal onChangeFunction={setOtp} toggleFunction={toggleModal} link="/customersignup" changeNoLink="/customersignup"/>
    </div>
  );
};
