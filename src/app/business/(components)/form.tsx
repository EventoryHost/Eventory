...
const Form = (props: Props) => {
  ...
  return (
    <div
      className="mx-3 my-9 mt-16 flex items-center text-white justify-center rounded-xl bg-indigo-600 py-10 md:mx-auto md:w-[80%]"
      style={{
    ...
    >
      <div className="flex w-full flex-col items-center justify-center px-4 py-5 md:px-0">
        ...
        <form
          className="mt-7 flex text-black min-w-[90%] flex-col items-center justify-center gap-5 rounded-xl bg-white px-4 py-5 md:min-w-[50%] lg:min-w-[40%]"
        ...
        >
          ...
          >
            <button
              ...
              className="flex h-max w-full border max-w-full justify-between overflow-hidden rounded-lg bg-white p-4 text-left"
