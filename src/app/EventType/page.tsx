...
const EventTypeHelper = () => {
    ...
    const venueNames = [
        "Diwali", "Holi", "Navratri", "Dusshera", "Ganesh Chaturthi", "Makar Sankranti"
    ];
    const baseImageUrl =
        ...
        <div className="flex flex-col bg-gray-100">
            ...
            <div className="flex w-full justify-center md:my-4">
                <Carousel
                    ...
                    className="mb-4 mt-4 w-full md:mb-0 md:max-w-[70%] max-w-[90%] "
                    onMouseEnter={plugin.current.stop}
                    onMouseLeave={plugin.current.reset}
                >
                    <CarouselContent className="flex md:gap-2 ">
                        {popular_events.map((venue, index) => (
                            <CarouselItem key={index} className="md:basis-[20%] basis-[40%]">
                                <div className="w-full">
                                    <div className="relative  aspect-[3/4] overflow-hidden rounded-xl cursor-pointer">
                                        ...
                                        <div className="absolute inset-0 flex flex-col items-start justify-end bg-black bg-opacity-50  text-white">
                                            <h3 className="m-2 text-center text-xs md:text-lg font-semibold  ">
                                                {venue.name}
                                            </h3>
            ...
            <div className="flex justify-between items-center">
                <div className="font-semibold text-5xl pl-10">Gift Vendors</div>
            ...
            <div className="flex-start flex justify-between gap-6 bg-gray-100 mx-14">
