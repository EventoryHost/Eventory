...
const MyComponent: React.FC = () => {
  ...
  const s3Url = "https://eventory-bucket.s3.ap-south-1.amazonaws.com/Venues/harshi/documents/cancellation_policy";
    ...
    <div>
      ...
      {metadata && (
        <div>
          ...
          <pre>Custom Metadata: {JSON.stringify(metadata.Metadata, null, 2)}</pre>
        </div>
      )}
    </div>
  );
