                    ...
                    <div className="flex min-h-full min-w-full flex-col items-center gap-5">
                        <div className="flex min-w-full flex-col items-center justify-between gap-5 md:flex-row">
                            ...
                            <div className="flex min-w-[40%] flex-col gap-4">
                                ...
                                <Combobox
                                    options={workerOptions.map((worker: { value: any; label: any; }) => ({ value: worker.value, label: worker.label }))}
                                    placeholder="select your category"
                                    setFunction={setWorkers}
                                    className="flex items-center text-gray-500 justify-between rounded-xl border-2 py-6 hover:text-[#2E3192]"
                                />
                            </div>
                        </div>
                        <div className="flex min-w-full flex-col items-center justify-between gap-5 md:flex-row">
                            <div className="flex min-w-[40%] flex-col gap-4">
                                ...
                                onChange={(e) => setDesc(e.target.value)}
                                    id="url"
                                    type="text"
                                    className="w-full rounded-xl border-2  bg-white p-5 pt-3 pb-28  outline-none"
                                    placeholder="Enter your Description"
                                />
                            </div>
                            <div className="flex mt-5 flex-col gap-4 xs:min-w-[40%]">
                                <div className="flex min-h-full min-w-full flex-col items-center gap-5">
