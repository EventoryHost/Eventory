...
export function Partner() {
  return (
    <div className="flex bg-[#C1C9F7] flex-col-reverse md:flex-row md:gap-8 justify-center md:px-[3rem] md:py-3 space-y-4 md:space-y-0">
      ...
      <div className="flex-1 p-4 pt-6 flex flex-col items-start">
        <h2 className="lg:text-5xl text-3xl font-bold mb-4">
          Your Ultimate Event Planning Partner
        </h2>
        <p className="text-gray-700 lg:w-[50%] w-[85%]">
        ...
        <button className="mt-4 text-sm bg-[#2E3192] p-2 rounded-md text-white">
...
const items = [
  ...
  },
  {
    ...
    imageUrl: "https://d1u34m45xfa3ar.cloudfront.net/website/landing-page/know-more-image0",
  },
  {
