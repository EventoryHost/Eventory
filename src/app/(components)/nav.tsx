  ...
  return (
    ...
    >
      <div className="container flex items-center justify-between">
        ...
        <div className="menu-icon border-[rgba(161,161,161,1)] px-0 md:rounded-none md:border-0">
          <div className="flex flex-row gap-2">
            ...
            <div className="menu-icon items-center" onClick={handleShowNavbar}>
              <svg
                className={`hamburger mr-1 mt-2 items-center text-black ${showNavbar && "rotate-90 duration-100"}`}
                width="22"
                height="22"
                viewBox="0 0 24 24"
                fill="none"
        ...
        <div
          className={`nav-elements ${showNavbar && " sm:shadow-2xl md:shadow-none"}`}
        >
          <button
          ...
          <div className="flex w-auto items-center justify-center">
            <ul className={`text-xl`}>
              <li onClick={handleShowNavbar} className="top-margin">
                <Link href={"/about"}>
                  <p>About</p>
                </Link>
              </li>
