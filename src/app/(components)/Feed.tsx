        ...
        <div className="h-fit w-[100%]">
            <div className="flex justify-between items-start h-full">
                <div className="flex-1 flex flex-col pl-10 pt-20">
                    ...
                    <p className='mt-8 font-light  text-md'>Discover, compare, and book top-rated vendors <br />for weddings, corporate events, parties, and <br />more – all in one place.</p>
                    <div className='mt-8'>
                        <DropdownBar />
                    </div>
                </div>
