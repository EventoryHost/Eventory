...
const Appetizers = ({
  ...
  return (
    <div className="grid min-h-[100%] min-w-[100%] md:grid-cols-4 grid-cols-2  gap-3">
      {appetizers.map((appetizer, index) => (
        <button
          key={index}
          onClick={() => handleButtonClick(appetizer)}
          className={`text col-span-1 row-span-1 flex items-center justify-center rounded-2xl min-w-[7rem] border border-none px-2 py-3 md:text-[2vw] text-[3.5vw] font-medium outline-none lg:text-[1vw] ${
