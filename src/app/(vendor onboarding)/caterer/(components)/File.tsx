    ...
    return (
      <div className="flex w-full items-center justify-between gap-10 space-x-2 rounded-3xl border p-2 px-6">
        <div className="flex items-center gap-4">
          <img src={"https://eventory-web-prod.s3.ap-south-1.amazonaws.com/assets/components/selection/fileicon.svg"} className="h-8 w-8" alt="file" />
      ...
      <div className="flex flex-col gap-4">
        {files.map((f, index) => (
          ...
          >
            <div className="flex items-center gap-4">
              <img
                src={"https://eventory-web-prod.s3.ap-south-1.amazonaws.com/assets/components/selection/fileicon.svg"}
                className="h-8 w-8"
                alt="file"
              />
