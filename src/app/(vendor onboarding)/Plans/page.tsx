            ...
            <div className="grid gap-3 grid-cols-1 md:grid-cols-3 mt-[3rem] px-[72px]  rounded-2xl  h-[450px]">
                {
                    planDetails.map((plan) => (
                        <div className="custom-shadow flex flex-col h-[450px] rounded-2xl p-4   bg-[#ffffff] gap-3 justify-start">
                            ...
                            <div className="flex static flex-col gap-[14px] justify-start">
                                ...
                                <button className=" text-white bg-[rgba(46,49,146,1)] rounded-2xl p-4 font-poppins flex justify-center items-center h-[48px] w-[100%]">Buy Now</button>
                            </div>
                            <div className="h-[166px] mt-2 flex flex-col justify-start items-left rounded-2xl p-4 bg-[#F7F7FC]">
                                {
                                    plan.details.map((data) => (
                                        <div className="flex gap-[14px] justify-left items-center md:h-10">
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <g clip-path="url(#clip0_4505_21018)">
