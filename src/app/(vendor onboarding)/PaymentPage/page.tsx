  ...
  return (
    <div className="w-screen bg-[#F7F6F9] py-[3.5rem]">
      ...
      <div className="flex justify-start px-[72px]">
        <div className="flex w-screen flex-col justify-center gap-4">
          <div className="custom-shadow h-[262px] w-[856px] rounded-2xl bg-[#ffffff] p-5">
          ...
          <div className="custom-shadow h-[262px] w-[856px] rounded-2xl bg-[#ffffff] p-4"></div>
        </div>
        <div className="custom-shadow h-[320px] w-[518px] rounded-2xl bg-[#ffffff] p-4"></div>
      </div>
    </div>
  );
};
