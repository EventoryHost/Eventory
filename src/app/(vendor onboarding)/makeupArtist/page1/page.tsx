...
const makeupArtists_individual = [
...
const makeupArtists_organisation = [
  "Airbrush Makeup Artists",
  "Body Paint Artists",
  "Bridal Makeup Artists",
  "Celebrity Makeup Artists",
...
const Page = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (groupmembers) console.log("Group Members:", groupmembers);
      ...
      <div className="scroll-touch flex max-h-[calc(100vh-5.2rem)] min-w-[70%] flex-col items-center gap-9 overflow-y-scroll bg-[#F7F6F9] p-2 md:p-[1rem]">
        ...
        {category === "Individual" && (
          <div className="flex flex-col gap-9 rounded-xl bg-white p-3 xs:min-w-[90%] md:p-6">
            ...
            <div className="flex min-h-full min-w-full flex-col items-center gap-5">
              <div className="flex min-w-full flex-col items-center justify-between gap-5 md:flex-row">
                <Appetizers appetizers={makeupArtists_individual} />
              </div>
        ...
        {category === "Group" && (
          <div className="flex flex-col gap-9 rounded-xl bg-white p-3 xs:min-w-[90%] md:p-6">
            ...
            <div className="flex min-h-full min-w-full flex-col items-center gap-5">
              <div className="flex min-w-full flex-col items-center justify-between gap-5 md:flex-row">
                <Appetizers appetizers={makeupArtists_groups} />
              </div>
              <div className="items-strech mt-9 flex flex-row gap-7 self-end">
                <button
                  className="rounded-xl border-2 border-[#2E3192] text-[#2E3192] xs:w-fit xs:px-3 xs:py-2 md:w-fit md:min-w-[10rem] md:px-4 md:py-3"
        ...
        {category === "Organisation" && (
          <div className="flex flex-col gap-9 rounded-xl bg-white p-3 xs:min-w-[90%] md:p-6">
            ...
            <div className="flex min-h-full min-w-full flex-col items-center gap-5">
              <div className="flex min-w-full flex-col items-center justify-between gap-5 md:flex-row">
                <Appetizers appetizers={makeupArtists_organisation} />
              </div>
              <div className="items-strech mt-9 flex flex-row gap-7 self-end">
                <button
                  className="rounded-xl border-2 border-[#2E3192] text-[#2E3192] xs:w-fit xs:px-3 xs:py-2 md:w-fit md:min-w-[10rem] md:px-4 md:py-3"
