...
const Page6: React.FC<Page6Props> = ({ formState, audioVisualEquipment, accessibilityFeatures, facilities, hourlyPackages, dailyPackages, seasonalPackages , _venue_restrictions , _venue_special_features }) => {
        ...
        <div className="flex h-full min-h-[calc(100vh-5.2rem)] w-full flex-col overflow-hidden lg:flex-row">
            <div className="flex flex-col items-start justify-between bg-[#FFFFFF] xs:gap-7 xs:pt-4 md:min-w-[30%] lg:max-w-[30%]">
                ...
                <div className="flex h-[50%] flex-col items-start justify-center gap-9 px-9 xs:pl-5 md:px-11 lg:p-8">
                    ...
                    <p className="text-gray-600 text-xl font-medium xs:text-sm md:w-[90%]">
            ...
            <div className="scroll-touch flex max-h-[calc(100vh-5.2rem)] min-w-[70%] flex-col items-center gap-9 overflow-y-scroll bg-[#F7F6F9] p-2 md:p-[1rem]">
                <div className="flex flex-col gap-7 rounded-xl bg-white p-3 xs:min-w-[90%] md:p-6">
                    <h1 className="text-3xl font-semibold">{formState.venueName}/Venue Providers</h1>

                    <div className="ml-8 mr-4 flex justify-between items-center rounded-xl  bg-[#F0EFFC] p-2 pl-4 text-2xl font-semibold">
                    ...
                    <div className="mx-8 mt-6 flex gap-16">
                        ...
                        <div className="flex w-1/2 flex-col">
                            ...
                            <span className="font-semibold">Seating :  {formState.seatingCapacity}  Standing : {formState.standingCapacity}</span>
                        </div>
                    </div>
                    ...
                    <div className="mx-8 mt-6 flex gap-16">
                        <div className="flex w-1/2 flex-col">
                            ...
                            <span className="mt-4 font-semibold">{formState.venueDescription}</span>
                        </div>
                        <div className="flex w-1/2 flex-col">
                            <span className="text-xl">Operating Hours</span>
                            <span className="font-semibold">{formState.startOperatingHours} am  -  {formState.endOperatingHours} pm</span>
                        </div>
                    </div>
                    ...
                    <div className="mx-8 mt-6 flex gap-16">
                        <div className="flex flex-col">
                            <span className="text-xl">Audio and Visual Equipments you provide</span>
                            <div className="flex mt-4 flex-wrap gap-2">
                                {audioVisualEquipment.map((item, index) => (
                                    <button
                                        key={index}
                                        className="bg-[#F0EFFC] text-gray-600 px-3 py-1 rounded-full text-sm md:text-base font-medium outline-none"
                                    >
                                        {item}
                                    </button>
                                ))}
                    ...
                    <div className="mx-8 mt-2 flex gap-16">
                        <div className="flex flex-col">
                            <span className="text-xl">Accessibility Features at your venue</span>
                            <div className="flex mt-4 flex-wrap gap-2">
                        ...
                        <div className="flex w-1/2 flex-col">
                            ...
                            {hourlyPackages.map((item, index) => (
                                <div key={index}>
                                    ...
                                    <span className="mt-4 font-semibold">{item.priceRange[0]} - {item.priceRange[1]}</span>
                                </div>
                            ))}
                        </div>
                        <div className="flex w-1/2 flex-col">
                    ...
                    <div className="mx-8 mt-6 flex gap-16">
                        <div className="flex flex-col">
                            <span className="text-xl">Restrictions and Policies at your venue</span>
                            <div className="flex mt-4 flex-wrap gap-2">
