...
const Page6: React.FC<Page6Props> = ({
  ...
  return (
    <div className="scroll-touch flex flex-col items-start gap-7 overflow-y-scroll scrollbar-hide rounded-xl bg-white p-3 w-full xs:justify-start">
        ...
        <div className="flex flex-col gap-7 rounded-xl bg-white p-3 xs:min-w-[90%] md:p-6">
          ...
          <div className=" mx-4  flex gap-16">
            <div className="flex w-1/2 flex-col">
              ...
              <span className="mt-4  text-sm font-bold">{formState.address}</span>
            </div>
            <div className="flex w-1/2 flex-col">
          ...
          <div className=" mx-4  flex gap-16">
            <div className="flex w-1/2 flex-col">
              <span className="  text-base font-normal">In-House Catering Service?</span>
              <span className="mt-4  text-sm font-bold">
                {formState.catererServices ? "Available" : "Not Available"}
              </span>
            </div>
            <div className="flex w-1/2 flex-col">
              <span className="  text-base font-normal">In-House Decorating Service?</span>
              <span className="mt-4  text-sm font-bold">
                {formState.catererServices ? "Available" : "Not Available"}
              </span>
            </div>
          ...
          <div className=" mx-4  flex gap-16">
            <div className="flex w-1/2 flex-col">
              <span className="  text-base font-normal">Special features at your venue</span>
              <div className="mt-4 flex flex-wrap gap-2">
          ...
          <div className=" mx-4  flex gap-16">
            <div className="flex w-1/2 flex-col">
              <span className="  text-base font-normal">Facilities at your venue</span>
              <div className="mt-4 flex flex-wrap gap-2">
          ...
          <div className=" mx-4  flex gap-16">
            ...
            <div className="flex w-1/2 flex-col">
              ...
              <span className="mt-4  text-sm font-bold">{formState.websiteURL}</span>
            </div>
          </div>
          ...
          <div className=" mx-4  flex gap-16">
            ...
            <div className="flex w-1/2 flex-col">
              <span className="  text-base font-normal">Insurance Coverage Policy</span>
              <div className="mt-4  text-sm font-bold">
