    ...
    <div className="scroll-touch flex flex-col items-start gap-7 overflow-y-scroll rounded-xl bg-white p-3 xs:w-[95%] xs:min-w-[90%] xs:justify-start">
      <div className="flex flex-col gap-7 rounded-xl bg-white p-3 xs:min-w-[100%] md:p-3">
        <div className="flex flex-col gap-7 rounded-xl bg-white p-3 xs:min-w-[90%] md:p-6">
          ...
          <div className="mx-2 w-full mr-4 flex items-center justify-between rounded-xl bg-[#F0EFFC] p-2 pl-4 text-2xl font-semibold">
          ...
          <div className="mx-8 mt-6 flex gap-16">
            <div className="flex w-1/2 flex-col">
              ...
              <span className="mt-4 font-semibold">{formState.catererServices ? "Available" : "Not Available"}</span>
            </div>
            <div className="flex w-1/2 flex-col">
          ...
          <div className="mx-8 mt-6 flex gap-16">
            <div className="flex w-1/2 flex-col">
              <span className="text-xl">Restricitons and Policies at your venue</span>
              <div className="mt-4 flex flex-wrap gap-2">
          ...
          <div className="mx-8 mt-2 flex gap-16">
            ...
            <div className="flex w-1/2 flex-col">
              ...
              <span className="mt-4 font-semibold">{formState.clientTestimonials}</span>
            </div>
          </div>
          ...
          <div className="mx-8 mt-2 flex gap-16">
            <div className="flex w-1/2 flex-col">
              ...
              <span className="mt-4 font-semibold">{formState.instagramURL}</span>
            </div>
            <div className="flex w-1/2 flex-col">
