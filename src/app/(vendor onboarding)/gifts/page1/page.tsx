          ...
          <div className="flex">
            <div className="flex w-1/2 flex-col items-center justify-between gap-5 md:flex-row">
              <div className="flex w-full flex-col gap-4 md:w-[60%]">
                <label className="font-medium" htmlFor="vendorName">Vendor Name (Manager)</label>
                <input
                  id="vendorName"
                  type="text"
            ...
            <div className="flex w-1/2 flex-col items-center justify-between gap-5 md:flex-row">
              <div className="flex w-full flex-col gap-4 md:w-[60%]">
                <label className="font-medium" htmlFor="contactNumber">Contact Number (POC)</label>
                <input
                  id="contactNumber"
                  type="text"
                  className="w-full rounded-xl border-2 bg-white p-5 py-3 outline-none"
          ...
          <div className="container">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-4">
                <div>
                  <label htmlFor="venueDescription" className="block mb-2 font-medium text-gray-900">
                    Your Description
                  </label>
                  <textarea
                    id="venueDescription"
                    placeholder="Enter your Venue description"
                    className="shadow h-36 appearance-none border rounded-xl w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline resize-none"
                  />
                </div>
                <div>
                  <label htmlFor="minimumQuantity" className="block mb-2 font-medium text-gray-900">
                ...
                <div>
                  ...
                  <div className="flex items-center">
                    ...
                    <input
                      ...
                      type="radio"
                      name="bulkQuantity"
                      className="form-radio h-4 w-4 text-indigo-600 focus:ring-indigo-500 ml-4"
                    />
                    <label
