...
const Page2: React.FC<PageProps> = ({
  ...
  return (
    <div className="flex h-full min-h-[calc(100vh-5.2rem)] w-full flex-col overflow-hidden lg:flex-row">
      ...
      <div className="flex md:w-[62em] flex-col gap-7 rounded-xl bg-white p-6 md:p-12 max-w-7xl mx-auto">
      <h2 className="text-2xl md:text-3xl font-semibold">Catalog Details</h2>
          <h3 className="text-lg md:text-xl font-medium">List of Gifts</h3>
          <div className="flex flex-col items-center gap-5">
            <div className="flex flex-col w-full gap-5 md:flex-row md:gap-5">
              <Appetizers
        ...
        <div className="flex w-full flex-col items-center justify-center bg-[#F7F6F9] p-2">
          <div className="flex w-[95%] flex-col gap-7 rounded-xl bg-white p-12">
            ...
            <input
              ...
              className="w-1/2 md:w-1/3 rounded-xl border-2 px-3 py-2 focus:border-[#2E3192] focus:outline-none focus:ring-blue-500"
            />
          </div>
        </div>
      </div>
