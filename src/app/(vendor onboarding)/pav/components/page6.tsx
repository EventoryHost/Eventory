            ...
            <div className="flex min-w-full flex-col items-start justify-around gap-10">
                <div className="flex w-[100%] flex-col gap-7 rounded-xl bg-white p-4 xs:min-w-[90%] md:p-6">
                    <div className="flex justify-start gap-5 items-center">
                        ...
                        <div className="flex"><h1 className="text-3xl font-semibold">Photo And Videography</h1></div>
                    </div>
                    ...
                    <div className="flex gap-9">
                        ...
                        <div className="mt-4 gap-6 justify-start flex flex-col">
                            <div className="flex justify-between items-start">
                                <div className="w-[50%]">
                                    ...
                                    <h3 className="text-lg text-[#263238] font-semibold font-helvetica">{fullName}</h3>
                                </div>
                                <div className="w-[50%]">
                                    <h2 className="text-lg text-[#263238] font-medium font-poppins">Event Size</h2>
                                    <h3 className="text-lg text-[#263238] font-semibold font-helvetica">{eventsize}</h3>
                                </div>
                            </div>
                            <div>
                                <h2 className="text-lg text-[#263238] font-medium font-poppins">Decoration Setup Duration</h2>
                                <h3 className="text-lg text-[#263238] font-semibold font-helvetica">{description}</h3>
                            </div>
                        </div>
                        ...
                        <div className="w-full">
                            <div className="gap-6 my-4 flex flex-col">
                                <span className="text-xl">Types of Styles</span>
                                <Appetizers
                            ...
                            <div className="gap-6 my-4 flex flex-col">
                                <span className="text-xl">Equiment Available</span>
                                <Appetizers
                            ...
                            <div className="gap-6 my-4 flex flex-col">
                                <span className="text-xl">Add-One Or Upgrades Available</span>
                                <Appetizers
                            ...
                            <div className="gap-6 my-4 flex flex-col">
                                <span className="text-xl">Final Delivery Methods</span>
                                <Appetizers
                        ...
                        <div className="mt-4 gap-6 justify-start flex flex-col">
                            <div className="flex justify-between items-start">
                                <div className="w-[50%]">
                                    <h2 className="text-lg text-[#263238] font-medium font-poppins">Duration of Final Delivery of Photos/Videos</h2>
                                    <h3 className="text-lg text-[#263238]  font-helvetica">{Durationoffinaldelivery}</h3>
                                </div>
                                <div className="w-[50%]">
                                    <h2 className="text-lg text-[#263238] font-medium font-poppins">Package Type</h2>
                                    <h3 className="text-lg text-[#263238]  font-helvetica">{Packagetype}</h3>
                                </div>
                            </div>
                            <div className="flex justify-between items-start">
                                <div className="w-[50%]">
                                    <h2 className="text-lg text-[#263238] font-medium font-poppins">Do You Provide Design Proposals to Clients</h2>
                                    <h3 className="text-lg text-[#263238]  font-helvetica">{proposalsToClients  ? "Yes" : "No"}</h3>
                                </div>
                                <div className="w-[50%]">
                                    <h2 className="text-lg text-[#263238] font-medium font-poppins">Do You Provide Free Initial Consultation</h2>
                                    <h3 className="text-lg text-[#263238]  font-helvetica">{freeInitialConsultation  ? "Yes" : "No"}</h3>
                                </div>
                            </div>
                            <div className="flex justify-between items-start">
                                <div>
                                    <h2 className="text-lg text-[#263238] font-medium font-poppins">Do You Require Any Booking Deposits For Your Services ?</h2>
                                    <h3 className="text-lg text-[#263238]  font-helvetica">{bookingDeposit  ? "Yes" : "No"}</h3>
                                </div>
                                <div>
                                    <h2 className="text-lg text-[#263238] font-medium font-poppins">Are You Available For Desination Events Or Out OF Town Bookings ?</h2>
                                    <h3 className="text-lg text-[#263238]  font-helvetica">{availablefordestinationevents  ? "Yes" : "No"}</h3>
                                </div>
                            </div>
                            <div className="flex justify-between items-start">
                                <div>
                                    <h2 className="text-lg text-[#263238] font-medium font-poppins">Do You Provide Advance Set-Up ?</h2>
                                    <h3 className="text-lg text-[#263238]  font-helvetica">{advanceSetup  ? "Yes" : "No"}</h3>
                                </div>
                                <div>
                                    <h2 className="text-lg text-[#263238] font-medium font-poppins">Do You Offer Post-Production Services ?</h2>
                                    <h3 className="text-lg text-[#263238]  font-helvetica">{postproductionservices  ? "Yes" : "No"}</h3>
                                </div>
                            </div>
                        ...
                        <div className="mt-4 gap-6 justify-start flex flex-col">
                            <div className="flex justify-between items-start">
                                <div className="w-[50%]">
                                    ...
                                    <h3 className="text-lg text-[#263238]  font-helvetica">{Recongnition_awards}</h3>
                                </div>
                                <div className="w-[50%]">
                                    <h2 className="text-lg text-[#263238] font-medium font-poppins">Client Testimonials</h2>
                                    <h3 className="text-lg text-[#263238]  font-helvetica">{clientTestimonials}</h3>
                                </div>
                            </div>
                            <div className="flex justify-between items-start">
                                <div className="w-[50%]">
                                    <h2 className="text-lg text-[#263238] font-medium font-poppins">Instagram URL</h2>
                                    <h3 className="text-lg text-[#263238]  font-helvetica">{intstagramurl}</h3>
                                </div>
                                <div className="w-[50%]">
                                    <h2 className="text-lg text-[#263238] font-medium font-poppins">Website URL</h2>
                                    <h3 className="text-lg text-[#263238]  font-helvetica">{websiteurl}</h3>
                                </div>
                            </div>
                        </div>
