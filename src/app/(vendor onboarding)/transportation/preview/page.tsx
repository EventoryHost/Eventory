    ...
    return (
        <>
            <div className="flex flex-col gap-2 p-2">
                ...
                <div className="ml-8 mr-4 mt-4 flex flex-col lg:flex-row lg:justify-between rounded-xl bg-gray-200 p-2 pl-4 text-3xl font-semibold">
                ...
                <div className="flex flex-col lg:flex-row w-full lg:gap-4 mt-4">
                    <div className="w-full lg:w-1/2 p-4 lg:p-0">
                        <div className="flex flex-col">
                            <div className="p-4 pl-8">
                                <span className="text-xl">Terms and Conditions</span>
                            </div>
                            <span className="ml-8 mt-2 flex font-semibold items-center">
                                <span>Doc1.pdf</span>
                                <Check size={24} />
                            </span>
                        </div>
