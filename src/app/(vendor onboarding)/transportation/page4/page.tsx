                ...
                <div className="flex flex-col gap-7 rounded-xl bg-white p-3 xs:min-w-[90%] md:p-6">
                    ...
                    <div className="flex gap-20">
                        <div>
                            ...
                            <p className="text-xs text-gray-500 mb-3">PNG, PDF, JPG</p>
                            ...
                            <div className="flex min-w-[40%] flex-col gap-4">
                                <label className="text-lg" htmlFor="category">Or provide via</label>
                                <textarea
                                    id="url"
                                    className="w-96 h-32 rounded-xl border-2 bg-white p-5 pt-6 pb-28 outline-none resize-none overflow-hidden scrollbar-hide"
