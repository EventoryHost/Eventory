            ...
            {options.map((option) => (
              ...
              >
                {selectedOption === option ? (
                  <img
                    src={"https://eventory-web-prod.s3.ap-south-1.amazonaws.com/assets/components/selection/Choice_2.svg"}
                    className="h-5 w-5"
                    alt=""
                  />
                ) : (
                  <img
                    src={"https://eventory-web-prod.s3.ap-south-1.amazonaws.com/assets/components/selection/Choice.svg"}
                    className="h-5 w-5"
                    alt=""
                  />
                )}
