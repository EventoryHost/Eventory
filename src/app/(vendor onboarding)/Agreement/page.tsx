...
const Agreement = () => {
    ...
    return (
        ...
        <div className="bg-[#F7F6F9] w-screen flex justify-center">
            <div className=" bg-[#ffffff] rounded-2xl h-[66rem]  w-[68.75rem]  mt-12 pt-8 pl-8  pr-4">
                <div>
                ...
                <div className="w-[66.06rem] h-[828px]">
                    <div className="scrollbar-rounded-xl  pl-6 text-left absolute w-[66.06rem] text-gray-500 overflow-y-scroll h-[828px]">
