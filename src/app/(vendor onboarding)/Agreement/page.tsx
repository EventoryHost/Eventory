...
const Agreement = ({ setCurrentPage }: Pagechangetype) => {
  return (
    <div className="flex w-screen justify-center bg-[#F7F6F9]">
      <div className="mt-12 h-[66rem] w-[90%] rounded-2xl bg-[#ffffff] pl-4 pr-8 pt-8 md:w-[68%]">
        <div>
        ...
        <div className="relative h-[828px] w-full">
          <div className="scrollbar-rounded-xl absolute h-[828px] overflow-y-scroll p-5 text-justify text-gray-500">
            ...
            <p>
              ...
              your use of the Site. Our performance of these Terms and
        ...
        <div className="relative bottom-0 flex items-end justify-end gap-3 p-4">
          <button
