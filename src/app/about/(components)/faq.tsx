    ...
    <>
      <div className="mt-16 items-center justify-between sm:mx-10 sm:gap-0 sm:py-10 md:gap-20 md:py-10 lg:mx-16 lg:gap-40 lg:py-10">
        <div className="justify-center">
          <h2 className="mx-5 text-2xl font-semibold text-[rgba(0,0,0,1)] sm:mb-10 md:text-4xl lg:mb-14">
        ...
        <div className="">
          <div className="collapse collapse-plus border-b-1 border-[rgba(209,213,219,1)]">
            ...
            <div className="md:text-md font-Inter collapse-title text-sm">
          ...
          <div className="collapse collapse-plus border-b-1 border-[rgba(209,213,219,1)]">
            <input type="radio" name="my-accordion-3" defaultChecked />
            <div className="md:text-md text-smfont-Inter collapse-title text-sm">
