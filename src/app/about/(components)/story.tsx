          ...
          <div className="relative">
            <div className="px-5 max-sm:mx-[10px] sm:flex-row sm:gap-20 sm:py-10 md:mx-20 md:flex-row md:gap-20 md:py-10 lg:gap-40 lg:py-10">
              <div className="justify-center">
                <h2 className="font-poppins linear-gradient-colour text-left text-2xl font-semibold max-sm:mb-10 md:mb-10 md:text-4xl lg:mb-14">
                  Why choose us?
                </h2>
              </div>
            </div>

            <div className="absolute z-10 flex w-full flex-col items-center gap-5 text-[rgba(255,255,255,1)] max-sm:relative max-sm:top-[0px] max-sm:bg-[rgba(213,214,233,1)] sm:flex-row md:top-[120px] md:my-[50px] md:mt-[-20px] md:justify-center md:gap-5 lg:justify-around">
