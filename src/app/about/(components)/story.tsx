          ...
          <div className="relative">
            <div className="px-5 max-sm:mx-[10px] sm:flex-row sm:gap-20 sm:py-10 md:mx-20 md:flex-row md:gap-20 md:py-10 lg:gap-40 lg:py-10">
              <div className="justify-center">
                <h2 className="linear-gradient-colour text-left text-2xl font-semibold max-sm:mb-10 md:mb-10 md:text-4xl lg:mb-14">
                  Why choose us?
                </h2>
              </div>
            </div>

            <div className="absolute z-10 flex w-full flex-col flex-wrap items-start justify-center gap-6 p-4 px-10 text-[rgba(255,255,255,1)] max-sm:relative max-sm:top-[0px] max-sm:bg-[rgba(213,214,233,1)] sm:flex-row md:top-[120px] md:my-[50px] md:mt-[-20px] md:justify-center md:gap-5 lg:justify-around">
              <div className="max-h-sm mx-auto flex w-full max-w-sm flex-col justify-between gap-10 rounded-lg bg-[rgba(96,94,216,1)] p-6 text-white shadow-lg sm:w-16 md:w-72 lg:w-80">
                <h2 className="mb-4 text-center font-poppins text-sm font-semibold md:text-2xl">
                  Innovation and Excellence
                </h2>
                <div className="mb-4 flex flex-grow justify-center text-sm">
                  <svg
                    width="91"
                ...
                <p className="text-start text-xs md:text-sm lg:mb-1">
                  ...
                  Committed to high standards of quality, ensuring perfection in
                  every aspect of our work.
                </p>
              </div>
              <div className="max-h-sm mx-auto flex w-full max-w-sm flex-col justify-between gap-10 rounded-lg bg-[rgba(96,94,216,1)] p-6 text-white shadow-lg sm:w-64 md:w-72 lg:w-80">
                <h2 className="mb-4 text-center font-poppins text-sm font-semibold md:text-2xl">
                  Customer <br /> Focus
                </h2>
                <div className="mb-4 flex flex-grow justify-center">
                  <svg
                    width="73"
                ...
                <p className="mt-8 flex-grow text-start text-xs md:mt-12 md:text-sm lg:mb-2 lg:mt-8">
              ...
              <div className="max-h-sm mx-auto flex w-full max-w-sm flex-col justify-between gap-10 rounded-lg bg-[rgba(96,94,216,1)] p-6 text-white shadow-lg sm:w-64 md:w-72 lg:w-80">
                ...
                <div className="mb-4 flex flex-grow justify-center">
                  <svg
                    width="96"
                    className="h-10 w-10 sm:h-12 sm:w-12 md:h-16 md:w-16 lg:h-24 lg:w-24"
                    height="96"
                    viewBox="0 0 96 96"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <p className="-mt-7 text-start text-xs md:text-sm lg:-mb-1">
                  Conducting business with transparency, honesty, and
                  Emphasizing teamwork within our organization and with clients
