    ...
    <>
      <div className="">
        <div className="w-full  bg-[rgba(213,214,233,1)] shadow-lg">
          <div className="flex flex-col items-center justify-between px-5 max-sm:mx-[10px] sm:flex-row sm:gap-20 sm:py-10 md:mx-20 md:flex-row md:gap-20 md:py-10 lg:gap-40 lg:py-10">
            <div className="flex-1 justify-center">
              <h2 className="linear-gradient-colour mt-5 font-serif text-2xl font-semibold max-sm:my-5 sm:mb-10 md:text-4xl lg:mb-14">
                The Story of Eventory
              </h2>
              <p className="text-xs text-[rgb(0,0,0)] md:text-lg">
          ...
          <div className="flex flex-col items-center justify-between px-5 max-sm:mx-[10px] sm:flex-row-reverse sm:gap-20 sm:py-10 md:mx-20 md:flex-row-reverse md:gap-20 md:py-10 lg:gap-40 lg:py-10">
            <div className="flex-1 justify-center">
              <h2 className="linear-gradient-colour font-serif text-2xl font-semibold max-sm:my-5 sm:mb-10 md:text-4xl lg:mb-14">
                We Provide Experience
              </h2>
              <p className="text-xs text-[rgba(0,0,0,1)] md:text-lg">
          ...
          <div className="flex flex-col items-center justify-between px-5 max-sm:mx-[10px] sm:flex-row sm:gap-20 sm:py-10 md:mx-20 md:flex-row md:gap-20 md:py-10 lg:gap-40 lg:py-10">
            <div className="flex-1 justify-end">
              ...
              <p className="pt-0 text-xs text-[rgba(0,0,0,1)] md:pt-10 md:text-lg">
            ...
            <div className="flex flex-1 justify-center">
              <img
                ...
                className="rounded-lg max-sm:my-10 max-sm:w-[300px]"
                alt=""
              />
            </div>
          </div>
          ...
          <div className="relative">
            <div className="px-5 max-sm:mx-[10px] sm:flex-row sm:gap-20 sm:py-10 md:mx-20 md:flex-row md:gap-20 md:py-10 lg:gap-40 lg:py-10">
              <div className="justify-center">
                <h2 className="font-semibold linear-gradient-colour text-left text-2xl max-sm:mb-10 md:mb-10 md:text-4xl lg:mb-14">
                  Why choose us?
                </h2>
              </div>
            </div>
            ...
            <div className="flex-wrap justify-center  gap-6 p-4 px-10 absolute z-10 flex w-full flex-col items-start text-[rgba(255,255,255,1)] max-sm:relative max-sm:top-[0px] max-sm:bg-[rgba(213,214,233,1)] sm:flex-row md:top-[120px] md:my-[50px] md:mt-[-20px] md:justify-center md:gap-5 lg:justify-around">
              
              <div className="bg-[rgba(96,94,216,1)] flex flex-col justify-between gap-10 w-full sm:w-16 md:w-72 lg:w-80  text-white p-6 rounded-lg shadow-lg max-w-sm max-h-sm mx-auto ">
                <h2 className="font-poppins text-center md:text-2xl text-sm font-semibold mb-4 ">Innovation and Excellence</h2>
                <div className="flex justify-center mb-4 flex-grow text-sm">
                <svg
                      width="91"
                ...
                <p className="text-start text-xs md:text-sm lg:mb-1">
                  Creating cutting-edge technology to deliver our mission. Committed to
                  high standards of quality, ensuring perfection in every aspect of our
                  work.
                </p>
              </div>
              <div className="bg-[rgba(96,94,216,1)] flex flex-col justify-between gap-10 w-full sm:w-64 md:w-72 lg:w-80  text-white p-6 rounded-lg shadow-lg max-w-sm max-h-sm  mx-auto">
                <h2 className=" font-poppins text-center md:text-2xl text-sm font-semibold mb-4 ">Customer <br/> Focus</h2>
                ...
                <p className="text-start text-xs md:text-sm flex-grow mt-8 md:mt-12 lg:mt-8 lg:mb-2">
                Tailoring services to meet customer needs, prioritizing
                customer satisfaction.
                </p>
              </div>
              <div className="bg-[rgba(96,94,216,1)] flex flex-col justify-between gap-10 w-full sm:w-64 md:w-72 lg:w-80 text-white p-6 rounded-lg shadow-lg max-w-sm max-h-sm  mx-auto">
                <h2 className="font-poppins text-center md:text-2xl text-sm font-semibold mb-4">
                ...
                <p className="text-start text-xs md:text-sm -mt-7 lg:-mb-1">
              ...
              {/* <div className="mb-10 h-[400px] w-[300px] rounded-lg bg-[rgba(96,94,216,1)] p-8 text-white sm:w-[300px] md:h-[412px] md:w-[346px]">
                <div className="flex flex-col items-center gap-14">
                  ...
                  <div className="flex h-16 w-16 items-center justify-center text-indigo-600 md:h-20 md:w-20">
                    <svg
                      width="91"
                      height="81"
                      viewBox="0 0 91 81"
                  ...
                  <p className="md:text-md text-start text-sm">
              ...
              <div className="mb-10 h-[400px] w-[300px] rounded-lg bg-[rgba(96,94,216,1)] p-8 text-white md:h-[412px] md:w-[346px]">
                <div className="flex flex-col items-center gap-14">
                  <div className="pb-2">
                    <h2 className="font-semibold md:text-xl">Customer Focus</h2>
                  </div>
