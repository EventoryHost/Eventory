...
const Events = (props: Props) => {
  return (
    <>
      <div className="2 mt-[450px] md:mt-[800px] lg:mt-[800px] xl:mt-[450px]  items-center justify-between max-sm:mt-[100px] sm:mx-10 sm:gap-0 sm:py-5 md:gap-20 md:py-5 lg:mx-16 lg:gap-40 lg:py-5">
