        ...
        <div className="relative mx-auto overflow-hidden xs:mt-8">
          ...
          >
            {items.map((item, index) => (
              ...
              >
                <div className="order-2 rounded-none bg-[rgba(46,49,146,0.1)] px-5 pt-5 text-left xs:w-[200px] xs:rounded-b-2xl sm:w-[300px] sm:rounded-l-2xl md:order-1 md:ml-20 md:h-[300px] md:w-2/3">
                  <div className="mb-5">
                    <svg
                      width="40"
                      height="33"
                ...
                <div className="order-1 mr-16 flex items-start justify-start max-sm:pl-[60px] md:order-2 md:w-1/3">
                  <img
                    src={item.image}
                    alt={item.name}
                    className="h-[200px] rounded-2xl object-cover xs:w-[400px] md:h-[400px] md:w-[300px]"
                  />
                </div>
              </div>
            ))}
          ...
          <button
            onClick={prevSlide}
            className="t absolute top-1/2 -translate-y-1/2 transform rounded-full p-2"
          >
            <svg
              width="42"
              height="43"
