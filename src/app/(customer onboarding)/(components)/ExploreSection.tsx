...
export default function ExploreSection() {
  ...
  return (
    <div
      className="relative flex h-[300px] w-full items-center justify-between transition-opacity duration-1000 ease-in-out"
      style={{
        background:
    ...
    >
      ...
      <div className="relative h-full w-[30%] overflow-hidden rounded-xl">
        {/* Image */}
        <div
