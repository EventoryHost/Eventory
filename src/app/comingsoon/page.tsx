  ...
  return (
    <div className="">
      <CategoryBar
        ...
        setView={setView}
      />
      <div className='flex justify-between gap-8 flex-start'>
        <div className='w-[60%] py-8 bg-slate-800'> main</div>
        <div className=' p-6 mx-6 flex flex-col gap-6 w-1/4 rounded-lg border border-gray-300 pb-4'>
          <div className='flex '>
