...
export const InfiniteMovingCards = ({
  ...
  // Deteled side mask css from scroller class: "[mask-image:linear-gradient(to_right,transparent,white_20%,white_80%,transparent)]"
        ...
        {items.map((item, idx) => (
          ...
          >
            ...
            <blockquote className="relative z-20">
              ...
              ></div>
              <span className="relative z-20 text-sm font-normal leading-[1.6] text-gray-100"></span>
              <div className="relative z-20 mt-6 flex flex-row items-center">
                <span className="flex flex-col gap-1">
                  <span className="text-sm font-normal leading-[1.6] text-gray-400"></span>
                  <span className="text-sm font-normal leading-[1.6] text-gray-400"></span>
                </span>
              </div>
            </blockquote>
