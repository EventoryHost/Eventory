...
const MultipleDropdown: React.FC<DropdownProps> = ({
  ...
  return (
    <div className="relative w-full">
      ...
      >
        <span
          className={`${selectedOptions.length ? "text-black" : "text-gray-400"}`}
        >
          {renderSelectedText()}
        </span>
            ...
            {options.map((option) => (
              ...
              >
                {selectedOptions.some(
                  ...
                  <img src={"https://eventory-bucket.s3.ap-south-1.amazonaws.com/public/selection/Choice_2.svg"} className="h-5 w-5" alt="img not found" />
                ) : (
                  <img src={"https://eventory-bucket.s3.ap-south-1.amazonaws.com/public/selection/Choice.svg"} className="h-5 w-5" alt="img not found" />
                )}
